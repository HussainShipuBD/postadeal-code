...
<!-- 
  <div class="wrapper ovh position-relative bgc-white ">
      ...
      <?php
         ...
         // die;
      ?>
      <section class="listing-title-area mt50 " id="tab-1">
         <div class="container">
            
            <div class="row detail_tpp">
               <div class="col-12 col-lg-8 ">
                  <div class="row">
                  <?php 
                     $images = json_decode($itemdetails->images, TRUE); 
               ...
               <div class="col-lg-4 col-xl-4 detail_wids">
                  <div class="detail_make_fix">
      ...
      <section class="our-agent-single  pb30-991 mt-3 detail_tpp">
         <div class="container">
            <div class="row">
...
<script>
   ...
   $(document).ready(function () {
      alert('hii');
      var a = $(".detail_wids").outerWidth();
      $(".detail_make_fix ").css('width', parseInt(a) - 50);
      // alert(width)
      var project2 = $('.detail_tpp').offset();
      //   alert(project2)

      //   var footer = $('.airfcfx-footer-app-sec').offset().top;
      var footer = $('.feat_property').offset().top;
      var $window = $(window);

      $window.scroll(function () {
         //start fix
         if ($(window).width() > 992) {
            if ($window.scrollTop() >= (project2.top + -80) && $window.scrollTop() <= (parseInt(footer) - 580)) {
               $(".detail_make_fix ").addClass("fixed_tops");
            } else {
               $(".detail_make_fix ").removeClass("fixed_tops");
            }
         }
      });
   });
            ...
            success: function (res) {
               if(res){
                  ...
                  if(status == 'false') {
                     ...
                     if(message == 'Chat Created Successfully') {
                        alert(message)
                        $.ajax({
