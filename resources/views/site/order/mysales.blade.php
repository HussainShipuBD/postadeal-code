            ...
            <div class="container">
                ...
                <div class="breadcrumb_content style2 mt-3 ml-0 d-flex justify-content-between ">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active text-thm" aria-current="page">My Sales</li>
                    </ol>
                                    ...
                                    <div class="my_dashboard_review mb40">
                                        <div class="row">
                                            <div class="col-xl-6 ml-0 my-3">
                                                ...
                                                <h3 class="white-nowrap h3">My Sales</h3>
                                                ...
                                                <div class="details">
                                                    <div class="tc_content">
                                                        ...
                                                        <div class="text-gray-color mb-1">
                                                            ...
                                                            <span class="txt-truncate ">{{$ordercollections['buyername']}}</span>
                                                        </div>
                                                        <div class="text-gray-color mb-1">
