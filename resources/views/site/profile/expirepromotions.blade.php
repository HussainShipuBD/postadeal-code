                                        ...
                                        <div class="favorite_item_list">
                                            ...
                                            <div class="ui_kit_tab ">
                                                ...
                                                <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="{{ route('site.profile.activepromotions')}}">Active</a>
                                                    </li>
                                                    <li class="nav-item">
                                                ...
                                                <div class="tab-content" id="myTabContent2">
                                                    ...
                                                    <div id="item2-tab" class="container tab-pane fade">
                                                        ...
                                                        <a href="{{ route('site.profile.promotiondetails', ['userId' => $userId , 'itemId' => $useritems['itemid'] , 'page' => 'expirepromotions']) }}">
                                                            <div class="feat_property list favorite_page">
                                                                ...
                                                                <div class="details">
                                                                    <div class="tc_content">
                                                                        ...
                                                                        <div class="fp_price text-thm" href="#">{{$useritems['itemcurrency']}}{{$useritems['itemprice']}}
                                                                        </div>
                                                                        <div class="d-flex flex-wrap">
                                                                            ...
                                                                            <p class="">
                                                                                ...
                                                                                {{Carbon\Carbon::parse($chatMesssages['featureexpireOn'])->format('j M, Y')}}
                                                                            </p>
                                                    ...
                                                    <?php } else { ?>
                                                            ...
                                                            <div class="feat_property list favorite_page">
                                                                <h3>No expire promotion listings.</h3>
                                                            </div>
                                            ...
                                            <div class="mbp_pagination">
                                                <ul class="page_navigation">
                                                    ...
                                                    <a class="page-link" href="{{ route('site.profile.expirepromotions', ['page' => $pageLeft]) }}" tabindex="-1"
                                                            aria-disabled="true">
                                                    ...
                                                    <li class="page-item @if($page == $i) active @endif">
                                                        ...
                                                        <a class="page-link" href="{{ route('site.profile.expirepromotions', ['page' => $i]) }}">{{$i}}
                                                    ...
                                                    <li class="page-item @if($page == $pagecount) disabled @endif">
                                                        <a class="page-link" href="{{ route('site.profile.expirepromotions', ['page' => $pageRight]) }}"><span
