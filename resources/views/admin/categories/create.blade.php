...
@include('admin.layouts.flashmessage')
    ...
    <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="font-size:18px;">Add Main Category</h4>
                    ...
                    @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="file" accept="image/image/gif,image/jpeg" id="wizard-picture" name="category_image" class="form-control m-b15 p-2 borderGrey w-100" required><br>
