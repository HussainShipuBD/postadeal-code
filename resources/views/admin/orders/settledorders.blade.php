...
@include('admin.layouts.flashmessage')
    ...
    <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="font-size:18px;">Settled Orders</h4>
            ...
            @if(!empty($newordersrecords))
                @foreach($newordersrecords as $newordersrecords)
                        ...
                        <a href="{{ route('orders.view', ['orderId' => $newordersrecords['_id'], 'page'=>'settled']) }}"><button class="btn btn-info align-text-top border-0"><i class="fa fa-eye"></i></button></a>
                      </div>
                          </td>
