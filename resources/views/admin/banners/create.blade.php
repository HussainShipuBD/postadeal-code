@include('admin.layouts.sidebar')
    ...
    <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="font-size:18px;">Add Banner</h4>
                    ...
                    @csrf
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Banner Name" name="banner_name" required>
                        @if ($errors->has('banner_name'))<p class="text-danger">{{ $errors->first('banner_name') }}</p>@endif
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Banner Name</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Banner URL" name="banner_url" required>
                      ...
                      <div class="form-group">
                        ...
                        <input type="file" accept="image/image/gif,image/jpeg" id="wizard-picture" name="banner_image" class="form-control m-b15 p-2 borderGrey w-100" required><br>
                        
                        <img src="" class="borderCurve borderGradient picture-src dnone" id="wizardPicturePreview"
              style="width:100px;height:100px;object-fit: cover; margin-top:20px; display:none;">
